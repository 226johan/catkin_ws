...
(cl:defmethod cl:initialize-instance :after ((m <AddInts-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddInts-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name learning_service-srv:<AddInts-request> is deprecated: use learning_service-srv:AddInts-request instead.")))

(cl:ensure-generic-function 'num1-val :lambda-list '(m))
(cl:defmethod num1-val ((m <AddInts-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learning_service-srv:num1-val is deprecated.  Use learning_service-srv:num1 instead.")
  (num1 m))

(cl:ensure-generic-function 'num2-val :lambda-list '(m))
(cl:defmethod num2-val ((m <AddInts-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learning_service-srv:num2-val is deprecated.  Use learning_service-srv:num2 instead.")
  (num2 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AddInts-request>)))
  ...
  "learning_service/AddIntsRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AddInts-request)))
  "Returns string type for a service object of type 'AddInts-request"
  "learning_service/AddIntsRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <AddInts-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddInts-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name learning_service-srv:<AddInts-response> is deprecated: use learning_service-srv:AddInts-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AddInts-response>)))
  ...
  "learning_service/AddIntsResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AddInts-response)))
  "Returns string type for a service object of type 'AddInts-response"
  "learning_service/AddIntsResponse")
